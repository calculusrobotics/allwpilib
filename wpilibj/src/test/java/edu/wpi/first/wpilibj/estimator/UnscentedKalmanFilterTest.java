...
public class UnscentedKalmanFilterTest {
  ...
  public void testConvergence() {
    ...
    assertEquals(finalPosition.poseMeters.getTranslation().getX(), observer.getXhat(0), 0.1);
    assertEquals(finalPosition.poseMeters.getTranslation().getY(), observer.getXhat(1), 0.1);
