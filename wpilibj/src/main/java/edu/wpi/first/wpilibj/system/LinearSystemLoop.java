...
public class LinearSystemLoop<S extends Num, I extends Num,
  ...
  public LinearSystemLoop(Nat<S> states, LinearSystem<S, I, O> plant,
                          ...
                          double dtSeconds) {
    this(states, plant, controller, new LinearPlantInversionFeedforward<>(plant, dtSeconds),
  ...
  public LinearSystemLoop(Nat<S> states, LinearSystem<S, I, O> plant,
    ...
    this(states, plant, controller, feedforward,
  ...
  public void setNextR(double... nextR) {
    ...
    m_nextR = new MatBuilder<>(m_states, Nat.N1()).fill(nextR);
  }
